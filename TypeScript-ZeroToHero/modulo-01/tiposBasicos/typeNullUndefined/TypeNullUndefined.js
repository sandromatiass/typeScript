...
// ==> Diferença e Similaridades: Null vc Undefined
console.log('Exemplo01:', null == undefined); // aqui compara o resultado
console.log('Exemplo02:', null === undefined); // aqui e comparado o tipo
