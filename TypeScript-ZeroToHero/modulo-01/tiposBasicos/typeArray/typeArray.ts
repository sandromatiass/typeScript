...
let frutas: string[] = ['Abacaxi', 'Manga', 'Maça', 'Morango', 'Laranja'];
console.log(frutas[2]);

// ==> Exemplo 02 - Array Object

let frutas1: Array<string> = ['Abacaxi', 'Manga', 'Maça', 'Morango', 'Laranja'];
console.log(frutas[2]);

// ==> Exemplo 03 - Adicionando masi strings com método 'push'

let idiomas: Array<string> = ['Português', 'Inglês', 'Alemão', 'Mandarin'];
console.log(idiomas);
...
let idiomas1: Array<string> = ['Português', 'Inglês', 'Alemão', 'Mandarin'];
